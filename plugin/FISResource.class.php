...
class FISResource {
    ...
    const HEAD_CONTENT_HOOK = '<!--[FIS_HEAD_CONTENT_HOOK]-->';
    ...
    public static function appendHeadContent($strContent){
        self::$headContent .= $strContent . PHP_EOL;
    }

    public static function headHook(){
        return self::HEAD_CONTENT_HOOK;
    }
    ...
    public static function renderResponse($strContent){
        $headContentIntPos = strpos($strContent, self::HEAD_CONTENT_HOOK);
        if($headContentIntPos !== false){
            $strContent = substr_replace($strContent, self::render('headContent'), $headContentIntPos, strlen(self::HEAD_CONTENT_HOOK));
        }
    ...
    public static function render($type){
        ...
        } else if($type === 'headContent'){
            $html .= self::$headContent;
        }
    ...
    public static function register($strNamespace, $smarty){
        if($strNamespace === '__global__'){
            ...
            if (defined('FBU_SMARTY_PROJECT_BASIC_DIR')) {
                $strMapName = FBU_SMARTY_PROJECT_BASIC_DIR . $strNamespace . '-map.json';
            } else {
